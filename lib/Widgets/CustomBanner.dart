...
const double _kOffset = 50.0; // distance to bottom of banner, at a 45 degree angle inwards
const double _kHeight = 20.0; // height of banner
...
enum CustomBannerLocation {
  ...
  /// (or [CustomBanner.layoutDirection]) is [TextDirection.rtl] and in the top-right
  /// corner when the ambient [Directionality] is [TextDirection.ltr].
  topEnd,

  /// Show the banner in the bottom-right corner when the ambient
  /// [Directionality] (or [CustomBanner.layoutDirection]) is [TextDirection.rtl] and
  ...
  double _translationX(double width) {
    ...
    switch (layoutDirection) {
      case TextDirection.rtl:
        switch (location) {
          case CustomBannerLocation.bottomEnd:
            return _kBottomOffset;
          case CustomBannerLocation.topEnd:
            return 0.0;
          case CustomBannerLocation.bottomStart:
            return width - _kBottomOffset;
          case CustomBannerLocation.topStart:
            return width;
        }
        break;
...
class CustomBanner extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<CustomBannerLocation>('location', location));
...
/// Displays a [CustomBanner] saying "DEBUG" when running in checked mode.
